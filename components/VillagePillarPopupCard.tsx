...
import type { VillagePillarProperties } from "@/types/gis";
...
} satisfies Record<VillagePillarProperties["status"], string>;

interface VillagePillarPopupCardProps {
  pillar: VillagePillarProperties;
}

export default function VillagePillarPopupCard({
  pillar,
}: VillagePillarPopupCardProps) {
  return (
    <div className="w-[296px] overflow-hidden rounded-[22px] border border-slate-200 bg-white shadow-[0_24px_60px_-28px_rgba(15,23,42,0.45)]">
      <div className="border-b border-slate-200 bg-gradient-to-r from-amber-950 via-slate-900 to-slate-800 px-5 py-4 text-white">
        <div className="mb-3 flex items-start justify-between gap-3">
          <div>
            <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-amber-200">
              Village Boundary Pillar
            </p>
        ...
        <p className="text-sm text-slate-300">
          Boundary reference pillar for village land parcel demarcation inside
          forest limits.
        </p>
      </div>
